# Generated by Django 3.0.7 on 2023-03-03 15:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('CT', 'Connecticut'), ('FL', 'Florida'), ('ID', 'Idaho'), ('IN', 'Indiana'), ('KS', 'Kansas')], max_length=100)),
                ...
                ('sell_date', models.DateField(default=datetime.datetime.now)),
